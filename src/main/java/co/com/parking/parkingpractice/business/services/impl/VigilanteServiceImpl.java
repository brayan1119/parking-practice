...
public class VigilanteServiceImpl implements VigilanteService {
	...
	// TODO Hacer DTO para esta respuesta
	@Override
	public void salirVehiculo(VehiculoDTO vehiculo) throws ExceptionTarifaNoEncontrada, ExecptionVehiculoNoPaqueado {
		try {
			...
			cobroService.calcularCobroVehiculo(vehiculo);
		}
